...
Relations can be backed by any type (reference or value types). The backing data is only shared if the component is a [shared component](/docs/Basic/Components/Shareables.md) itself.

The target of a relation must be [Alive](/docs/Basic/Entities/Liveness.md).
