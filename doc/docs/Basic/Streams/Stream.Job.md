...
You can also set the [Filter State](/docs/Intermediate/Filters/index.md) of your Query to only include the Archetypes you want to process as a `Stream.Job`, and use `Stream.For` to do the rest. Or make it even easier: **Create Two Queries.**
:::
