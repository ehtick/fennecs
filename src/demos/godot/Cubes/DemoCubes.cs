...
public partial class DemoCubes : Node
{
	...
	// Godot: The eight mode sims, in button order (a..h).
	...
	[Export] public Node SimGdMultimeshThreads = null!;
	...
	private Node[] _sims = [];
	private int _mode = 7; // default: h) fennecs + MultiMesh + Jobs
	...
	{
		_sims = [SimGdNodes, SimCsNodes, SimFennecsNodes, SimGdMultimesh, SimGdMultimeshThreads, SimCsMultimesh, SimFennecsFor, SimFennecsJobs];
